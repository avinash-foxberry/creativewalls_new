...
class Payment extends CI_Controller
{
    ...
    */
    function _removeSpaceAndPreparePostArray($params){
        $temp_array = array(
            ...
            'udf1' => trim( htmlentities($params['course_id'], ENT_QUOTES) ),
            'udf2' => trim( htmlentities($params['course_name'], ENT_QUOTES) ),
            'udf3' => trim( htmlentities($params['sub_course_id'], ENT_QUOTES) ),
            'udf4' => trim( htmlentities($params['sub_course_name'], ENT_QUOTES) ),
            'udf5' => trim( htmlentities($params['service_id'], ENT_QUOTES) ),
            'udf6' => trim( htmlentities($params['service_name'], ENT_QUOTES) ),
            ...
            // 'utf11'=> trim( htmlentities($params['service_id'], ENT_QUOTES) ),
            // 'utf12'=> trim( htmlentities($params['service_name'], ENT_QUOTES) ),
            // 'service_amount' => trim( htmlentities($params['service_price'], ENT_QUOTES) ),
            ...
            // 'show_payment_mode' => trim( htmlentities($params['show_payment_mode'], ENT_QUOTES) )
    ...
    */
    function _getReverseHashKey($response_array, $s_key){
        $reverse_hash_sequence = "udf12|udf11|udf10|udf9|udf8|udf7|udf6|udf5|udf4|udf3|udf2|udf1|email|firstname|productinfo|amount|txnid|key";
