...
<head>
    ...
    <script src="<?php echo base_url(); ?>assets/ajax/libs/intl-tel-input/17.0.8/js/intlTelInput.min.js"></script>

    <meta charset="UTF-8">
    <meta name="theme-color" content="#C85514">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no, shrink-to-fit=no">
    <script src="<?php echo base_url(); ?>assets/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

    <!-- End Webengage Pixel -->
    <script type="text/javascript ">
    var templateUrl = '<?php echo base_url(); ?>assets/themes/creativewalls';
    </script>
    <script src="<?php echo base_url(); ?>assets/ajax/libs/moment.js/2.24.0/moment.min.js"></script>
    <meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1'>
    <meta name="description"
    content="Creative Walls: India&#039;s best home interior design company in Pune, Mumbai,Amravati,Akola,Nagpur. 100+ homes, 20+ designers, 10 yrs warranty. Book FREE Consultation Now!">

    <title>Creative Walls - Complete Home Interiors | Best Interior Designers</title>
    <link rel="preload" data-rocket-preload="" as="font"
        href="<?php echo base_url(); ?>assets/themes/creativewalls/fonts/fontawesome-webfont.woff?v=4.7.0" crossorigin="">
    <link rel="preload" data-rocket-preload="" as="font"
        href="<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.woff" crossorigin="">
    <link rel="preload" data-rocket-preload="" as="font"
        href="<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-300.woff" crossorigin="">
    <link rel="preload" data-rocket-preload="" as="font"
        href="<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-700.woff" crossorigin="">
    <link rel="preload" data-rocket-preload="" as="font"
        href="<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-regular.woff" crossorigin="">
        <style type="text/css" src="<?php echo base_url(); ?>assets/css/main.css"></style>
    <style id="wpr-usedcss">
        ...
        .iti__flag {
            ...
            background-image: url("<?php echo base_url(); ?>assets/ajax/libs/intl-tel-input/17.0.8/img/flags.png");
        ...
        (min-resolution:192dpi) {
            ...
            .iti__flag {
                background-image: url("<?php echo base_url(); ?>assets/ajax/libs/intl-tel-input/17.0.8/img/flags@2x.png")
            }
        }
        ...
        @media(min-width:1024px) and (max-width:1279px) {
            ...
            .why-design-cafe-nav-text-main a {
                padding: 8px 12px
            }
        ...
        div.pp_default .pp_top .pp_left {
            background: var(--wpr-bg-45590ae3-7b61-4ccc-ad03-8e040dca3776) -78px -93px no-repeat
        }

        div.pp_default .pp_top .pp_middle {
            background: var(--wpr-bg-8af85f00-ac45-48cb-9c8f-bab2c8b68022) top left repeat-x
        }

        div.pp_default .pp_top .pp_right {
            background: var(--wpr-bg-190c0355-785e-4652-8b0d-d37e9a514c7e) -112px -93px no-repeat
        }
        ...
        div.pp_default .pp_content_container .pp_left {
            background: var(--wpr-bg-3db3feb6-7fcd-4675-846b-9bbf78a6fff6) -7px 0 repeat-y;
            padding-left: 13px
        }

        div.pp_default .pp_content_container .pp_right {
            background: var(--wpr-bg-fd880968-ba8f-4d08-9270-db8b9ad83d7f) top right repeat-y;
            padding-right: 13px
        }

        div.pp_default .pp_next:hover {
            background: var(--wpr-bg-7374e6d7-4a68-4100-a147-dc480aab054b) center right no-repeat;
            cursor: pointer
        }

        div.pp_default .pp_previous:hover {
            background: var(--wpr-bg-035a1b21-da92-42e5-8b79-bf2529184bc2) center left no-repeat;
            cursor: pointer
        }

        div.pp_default .pp_expand {
            background: var(--wpr-bg-e32335e1-8211-4658-9453-69d41b558d75) 0 -29px no-repeat;
            cursor: pointer;
            width: 28px;
            height: 28px
        }
        ...
        div.pp_default .pp_expand:hover {
            background: var(--wpr-bg-e1ec9ed3-7383-4e16-b316-64a061454e8b) 0 -56px no-repeat;
            cursor: pointer
        }

        div.pp_default .pp_contract {
            background: var(--wpr-bg-637fd2f8-0ea3-4b4a-bc53-1c8794816bb1) 0 -84px no-repeat;
            cursor: pointer;
            width: 28px;
            height: 28px
        }
        ...
        div.pp_default .pp_contract:hover {
            background: var(--wpr-bg-e7d06687-2b7a-4176-87fa-a80c61a6fa27) 0 -113px no-repeat;
            cursor: pointer
        }
        ...
        div.pp_default .pp_close {
            width: 30px;
            height: 30px;
            background: var(--wpr-bg-58a7d506-1cc7-4931-8fdf-800624010728) 2px 1px no-repeat;
            cursor: pointer
        }

        div.pp_default .pp_gallery ul li a {
            background: var(--wpr-bg-e2b9e95b-05e6-4378-bcc1-b62172d999e0) center center #f8f8f8;
        ...
        div.pp_default .pp_nav .pp_play {
            background: var(--wpr-bg-b7ccf834-80e5-4a51-94fc-e6b48b1da35a) -51px 1px no-repeat;
            height: 30px;
            width: 30px
        }
        ...
        div.pp_default a.pp_arrow_previous {
            background: var(--wpr-bg-52965cc0-21f9-4223-b41b-f588eedb68be) -31px -3px no-repeat;
            height: 20px;
            width: 20px;
            margin: 4px 0 0
        }
        ...
        div.pp_default .pp_bottom .pp_left {
            background: var(--wpr-bg-a758597f-cf4e-4337-a662-3e3de6741541) -78px -127px no-repeat
        }

        div.pp_default .pp_bottom .pp_middle {
            background: var(--wpr-bg-d45105e2-2d1b-44f2-8bf9-7e0423f3ee75) bottom left repeat-x
        }

        div.pp_default .pp_bottom .pp_right {
            background: var(--wpr-bg-245c4e8f-28fc-47d5-bdcd-7c05338eb2b6) -112px -127px no-repeat
        }

        div.pp_default .pp_loaderIcon {
            background: var(--wpr-bg-af792d68-c091-4c7c-81a0-2463aa405ab5) center center no-repeat
        }

        div.facebook .pp_top .pp_left {
            background: var(--wpr-bg-77f7677e-6a9e-468a-814b-03bcffeecf69) -88px -53px no-repeat
        }

        div.facebook .pp_top .pp_middle {
            background: var(--wpr-bg-7cc19d94-a631-453b-8550-f9fb3dfe548a) top left repeat-x
        }

        div.facebook .pp_top .pp_right {
            background: var(--wpr-bg-912d95eb-78b6-4362-a958-1b1779227798) -110px -53px no-repeat
        }

        div.facebook .pp_content_container .pp_left {
            background: var(--wpr-bg-b857d69a-2288-45e5-b067-9f79fe0b699b) top left repeat-y
        }

        div.facebook .pp_content_container .pp_right {
            background: var(--wpr-bg-34898ca2-f126-4559-a14e-6e1a45f2bea8) top right repeat-y
        }

        div.facebook .pp_expand {
            background: var(--wpr-bg-42b239bb-4656-448c-a479-744494406498) -31px -26px no-repeat;
            cursor: pointer
        }

        div.facebook .pp_expand:hover {
            background: var(--wpr-bg-a2a6d652-dac1-4635-b1bb-25cdfebc2f39) -31px -47px no-repeat;
            cursor: pointer
        }

        div.facebook .pp_contract {
            background: var(--wpr-bg-e3c9643b-ad3f-4549-8426-902209b3caeb) 0 -26px no-repeat;
            cursor: pointer
        }

        div.facebook .pp_contract:hover {
            background: var(--wpr-bg-5dca2f43-1665-484f-a119-6bb8f59fb8ee) 0 -47px no-repeat;
            cursor: pointer
        }
        ...
        div.facebook .pp_close {
            width: 22px;
            height: 22px;
            background: var(--wpr-bg-0610711a-fe29-4c54-9845-2eb81496c00f) -1px -1px no-repeat;
            cursor: pointer
        }
        ...
        div.facebook .pp_loaderIcon {
            background: var(--wpr-bg-588b7593-abcb-4341-837f-3f9df42c8c2e) center center no-repeat
        }

        div.facebook .pp_arrow_previous {
            background: var(--wpr-bg-4a15577e-09eb-42d2-95ec-fad0021ba012) 0 -71px no-repeat;
            height: 22px;
            margin-top: 0;
            width: 22px
        }
        ...
        div.facebook .pp_arrow_next {
            background: var(--wpr-bg-24ef0590-c03c-478a-9e26-75b9324759a0) -32px -71px no-repeat;
            height: 22px;
            margin-top: 0;
            width: 22px
        }
        ...
        div.facebook .pp_nav .pp_play {
            background: var(--wpr-bg-50234aa5-2572-4652-be10-4e733144e426) -1px -123px no-repeat;
            height: 22px;
            width: 22px
        }

        div.facebook .pp_nav .pp_pause {
            background: var(--wpr-bg-641214cc-059f-4152-be16-b40656c2eebd) -32px -123px no-repeat;
            height: 22px;
            width: 22px
        }

        div.facebook .pp_next:hover {
            background: var(--wpr-bg-6b1f9b9c-fd69-4006-9222-453cef8fcdf4) center right no-repeat;
            cursor: pointer
        }

        div.facebook .pp_previous:hover {
            background: var(--wpr-bg-5cfec786-97aa-4655-b9f8-e09c30ef62c8) center left no-repeat;
            cursor: pointer
        }

        div.facebook .pp_bottom .pp_left {
            background: var(--wpr-bg-e663823e-a09d-408c-84f6-62e4cb306250) -88px -80px no-repeat
        }

        div.facebook .pp_bottom .pp_middle {
            background: var(--wpr-bg-d6307336-ac47-4c62-a0df-9a7b1c4dc706) top left repeat-x
        }

        div.facebook .pp_bottom .pp_right {
            background: var(--wpr-bg-461223cf-0157-462e-9e8d-ef059d3acb6a) -110px -80px no-repeat
        }
        ...
        * html .pp_content {
        ...
        .pp_gallery li.default a {
            background: var(--wpr-bg-7b9a24b5-49a3-4e95-8fe2-12afca02cf3d) no-repeat;
            display: block;
            height: 33px;
            width: 50px
        }
        ...
        a.pp_next {
            background: var(--wpr-bg-e0d681f0-5757-4b84-a1c2-16e3bbb6d3e1) 10000px 10000px no-repeat;
            display: block;
            float: right;
            height: 100%;
            text-indent: -10000px;
        ...
        a.pp_previous {
            background: var(--wpr-bg-7684c17f-380c-4107-b89c-616fe082c5d1) 10000px 10000px no-repeat;
            display: block;
            float: left;
            height: 100%;
            text-indent: -10000px;
        ...
        *,
        ...
        @font-face {
            font-display: swap;
            font-family: Lato;
            src: url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.eot");
            src: url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100-1.eot") format("embedded-opentype"), url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.woff") format("woff"), url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.woff2") format("woff2"), url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.ttf") format("truetype"), url("<?php echo base_url(); ?>assets/themes/creativewalls/fonts/lato-v20-latin-100.svg") format("svg");
            font-weight: 100;
            font-style: normal
        }
        ...
        .owl-carousel .owl-video-play-icon {
            ...
            margin-left: -40px;
            margin-top: -40px;
            background: var(--wpr-bg-d4c8833e-470c-492c-b815-b29dd2532c8d) no-repeat;
            cursor: pointer;
            z-index: 1;
            -webkit-backface-visibility: hidden;
        ...
        .homepage-banner-bg {
            background-image: var(--wpr-bg-88f75afe-dbb0-4510-b147-3dab7b964f36);
        ...
        button.loading {
            background-image: var(--wpr-bg-a4a245a6-9277-4d67-9a79-c43f297d8e1c);
            background-repeat: no-repeat;
        ...
        button.loading {
            background-image: var(--wpr-bg-d68115a6-fba0-4de9-bbbc-e1f02b23d8c6);
            background-repeat: no-repeat;
            background-size: 20px 20px;
            padding-left: 30px
        }
        ...
        .row.our-suppliers-para-main p {
            ...
            font-size: 18px;
            margin-bottom: 50px;
            background-image: url(<?php echo base_url(); ?>assets/themes/creativewalls/images/our_suppliers_bg.webp)
        }
        ...
        @media (min-width:1920px) {
            ...
            .what-make-us-right-section-profile-desc {
                ...
                font-size: 24px;
                line-height: 32px;
                background-image: var(--wpr-bg-789d5d1c-c7d6-4918-81ee-758da498ae3a)
            }
        ...
        .location-tab-menus-nav .nav-tabs::-webkit-scrollbar-track {
            -webkit-box-shadow: inset 0 0 6px rgba(146, 127, 127, 0);
        ...
        .open-btn1.btnactive {
            background: var(--wpr-bg-b195aaec-296d-4d39-9b45-23751445fd16) 15px center no-repeat;
        ...
        #search-wrap input[type=submit] {
            ...
            top: 10px;
            right: 30px;
            background: var(--wpr-bg-2d951eca-c215-4f18-b106-986a0d18ca31) right no-repeat;
            background-size: 20px 20px;
            width: 30px;
            height: 60px;
            font-size: 0;
    ...
    <link rel="preload" data-rocket-preload="" as="image" href="<?php echo base_url(); ?>assets/themes/creativewalls/images/loading.gif"
        fetchpriority="high">
    ...
    <style id='rocket-lazyload-inline-css' type='text/css'>
        ...
        .rll-youtube-player .play {
            ...
            top: 0;
            position: absolute;
            background: var(--wpr-bg-0b072631-da55-4830-a0e2-91fb241f8591) no-repeat center;
            background-color: transparent !important;
            cursor: pointer;
            border: none;
        }
    ...
    <!--n2css--><!--n2js-->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/wp-includes/js/jquery/jquery.min.js" id="jquery-core-js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/wp-includes/js/jquery/jquery-migrate.min.js" id="jquery-migrate-js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/themes/creativewalls/js/custom.js?v=458210433"
        id="my_custom_js-js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/pixelyoursite/dist/scripts/jquery.bind-first-0.2.3.min.js"
        id="jquery-bind-first-js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/pixelyoursite/dist/scripts/js.cookie-2.1.3.min.js"
        id="js-cookie-pys-js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/pixelyoursite/dist/scripts/public.js" id="pys-js"></script>
    <link rel="https://api.w.org/" href="<?php echo base_url(); ?>assets/wp-json/index.htm">
    <link rel="alternate" title="JSON" type="application/json" href="<?php echo base_url(); ?>assets/wp-json/wp/v2/pages/152">

    <link rel="Shortcut Icon" type="image/x-icon" href="favicon.ico">
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title"
        content="Creative Walls - Complete Home Interiors | Best Home Interiors Company in Pune and Nagpur">
    ...
    <style id="wpr-lazyload-bg-exclusion">
        .homepage-banner-bg {
            --wpr-bg-88f75afe-dbb0-4510-b147-3dab7b964f36: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/loading.gif');
        }
    </style>
    <noscript>
        <style id="wpr-lazyload-bg-nostyle">
            div.pp_default .pp_top .pp_left {
                --wpr-bg-45590ae3-7b61-4ccc-ad03-8e040dca3776: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_top .pp_middle {
                --wpr-bg-8af85f00-ac45-48cb-9c8f-bab2c8b68022: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_x.png');
            }

            div.pp_default .pp_top .pp_right {
                --wpr-bg-190c0355-785e-4652-8b0d-d37e9a514c7e: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_content_container .pp_left {
                --wpr-bg-3db3feb6-7fcd-4675-846b-9bbf78a6fff6: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_y.png');
            }

            div.pp_default .pp_content_container .pp_right {
                --wpr-bg-fd880968-ba8f-4d08-9270-db8b9ad83d7f: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_y.png');
            }

            div.pp_default .pp_next:hover {
                --wpr-bg-7374e6d7-4a68-4100-a147-dc480aab054b: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_next.png');
            }

            div.pp_default .pp_previous:hover {
                --wpr-bg-035a1b21-da92-42e5-8b79-bf2529184bc2: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_prev.png');
            }

            div.pp_default .pp_expand {
                --wpr-bg-e32335e1-8211-4658-9453-69d41b558d75: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_expand:hover {
                --wpr-bg-e1ec9ed3-7383-4e16-b316-64a061454e8b: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_contract {
                --wpr-bg-637fd2f8-0ea3-4b4a-bc53-1c8794816bb1: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_contract:hover {
                --wpr-bg-e7d06687-2b7a-4176-87fa-a80c61a6fa27: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_close {
                --wpr-bg-58a7d506-1cc7-4931-8fdf-800624010728: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_gallery ul li a {
                --wpr-bg-e2b9e95b-05e6-4378-bcc1-b62172d999e0: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/default_thumb.png');
            }

            div.pp_default .pp_nav .pp_pause,
            div.pp_default .pp_nav .pp_play {
                --wpr-bg-b7ccf834-80e5-4a51-94fc-e6b48b1da35a: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default a.pp_arrow_next,
            div.pp_default a.pp_arrow_previous {
                --wpr-bg-52965cc0-21f9-4223-b41b-f588eedb68be: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_bottom .pp_left {
                --wpr-bg-a758597f-cf4e-4337-a662-3e3de6741541: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_bottom .pp_middle {
                --wpr-bg-d45105e2-2d1b-44f2-8bf9-7e0423f3ee75: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite_x.png');
            }

            div.pp_default .pp_bottom .pp_right {
                --wpr-bg-245c4e8f-28fc-47d5-bdcd-7c05338eb2b6: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/sprite.png');
            }

            div.pp_default .pp_loaderIcon {
                --wpr-bg-af792d68-c091-4c7c-81a0-2463aa405ab5: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/default/loader.gif');
            }

            div.facebook .pp_top .pp_left {
                --wpr-bg-77f7677e-6a9e-468a-814b-03bcffeecf69: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_top .pp_middle {
                --wpr-bg-7cc19d94-a631-453b-8550-f9fb3dfe548a: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/contentPatternTop.png');
            }

            div.facebook .pp_top .pp_right {
                --wpr-bg-912d95eb-78b6-4362-a958-1b1779227798: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_content_container .pp_left {
                --wpr-bg-b857d69a-2288-45e5-b067-9f79fe0b699b: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/contentPatternLeft.png');
            }

            div.facebook .pp_content_container .pp_right {
                --wpr-bg-34898ca2-f126-4559-a14e-6e1a45f2bea8: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/contentPatternRight.png');
            }

            div.facebook .pp_expand {
                --wpr-bg-42b239bb-4656-448c-a479-744494406498: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_expand:hover {
                --wpr-bg-a2a6d652-dac1-4635-b1bb-25cdfebc2f39: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_contract {
                --wpr-bg-e3c9643b-ad3f-4549-8426-902209b3caeb: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_contract:hover {
                --wpr-bg-5dca2f43-1665-484f-a119-6bb8f59fb8ee: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_close {
                --wpr-bg-0610711a-fe29-4c54-9845-2eb81496c00f: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_loaderIcon {
                --wpr-bg-588b7593-abcb-4341-837f-3f9df42c8c2e: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/loader.gif');
            }

            div.facebook .pp_arrow_previous {
                --wpr-bg-4a15577e-09eb-42d2-95ec-fad0021ba012: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_arrow_next {
                --wpr-bg-24ef0590-c03c-478a-9e26-75b9324759a0: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_nav .pp_play {
                --wpr-bg-50234aa5-2572-4652-be10-4e733144e426: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_nav .pp_pause {
                --wpr-bg-641214cc-059f-4152-be16-b40656c2eebd: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_next:hover {
                --wpr-bg-6b1f9b9c-fd69-4006-9222-453cef8fcdf4: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/btnNext.png');
            }

            div.facebook .pp_previous:hover {
                --wpr-bg-5cfec786-97aa-4655-b9f8-e09c30ef62c8: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/btnPrevious.png');
            }

            div.facebook .pp_bottom .pp_left {
                --wpr-bg-e663823e-a09d-408c-84f6-62e4cb306250: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            div.facebook .pp_bottom .pp_middle {
                --wpr-bg-d6307336-ac47-4c62-a0df-9a7b1c4dc706: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/contentPatternBottom.png');
            }

            div.facebook .pp_bottom .pp_right {
                --wpr-bg-461223cf-0157-462e-9e8d-ef059d3acb6a: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/sprite.png');
            }

            .pp_gallery li.default a {
                --wpr-bg-7b9a24b5-49a3-4e95-8fe2-12afca02cf3d: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/facebook/default_thumbnail.gif');
            }

            a.pp_next {
                --wpr-bg-e0d681f0-5757-4b84-a1c2-16e3bbb6d3e1: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/light_rounded/btnNext.png');
            }

            a.pp_previous {
                --wpr-bg-7684c17f-380c-4107-b89c-616fe082c5d1: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/prettyPhoto/light_rounded/btnNext.png');
            }

            .owl-carousel .owl-video-play-icon {
                --wpr-bg-d4c8833e-470c-492c-b815-b29dd2532c8d: url('<?php echo base_url(); ?>assets/themes/creativewalls/css/owl.video.play.png');
            }

            .open-btn1.btnactive {
                --wpr-bg-b195aaec-296d-4d39-9b45-23751445fd16: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/icon_search.svg');
            }

            #search-wrap input[type=submit] {
                --wpr-bg-2d951eca-c215-4f18-b106-986a0d18ca31: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/icon_search.svg');
            }

            .iti__flag {
                --wpr-bg-9e7f3e2f-cd92-4950-88af-1d136f7568cf: url('<?php echo base_url(); ?>assets/ajax/libs/intl-tel-input/17.0.8/img/flags.png');
            }

            .iti__flag {
                --wpr-bg-b892f171-296a-4a55-812c-ac35fbde3809: url('<?php echo base_url(); ?>assets/ajax/libs/intl-tel-input/17.0.8/img/flags@2x.png');
            }

            button.loading {
                --wpr-bg-a4a245a6-9277-4d67-9a79-c43f297d8e1c: url('<?php echo base_url(); ?>assets/uploads/2021/10/20190133/ajax-loader.gif');
            }

            button.loading {
                --wpr-bg-d68115a6-fba0-4de9-bbbc-e1f02b23d8c6: url('<?php echo base_url(); ?>assets/uploads/2021/10/20190133/ajax-loader.gif');
            }

            .row.our-suppliers-para-main p {
                --wpr-bg-7ba0cece-633b-4786-86ce-d4d3ad6eaf90: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/our_suppliers_bg.webp');
            }

            .what-make-us-right-section-profile-desc {
                --wpr-bg-789d5d1c-c7d6-4918-81ee-758da498ae3a: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/our_suppliers_bg.webp');
            }

            .what-make-us-right-section-profile-desc {
                --wpr-bg-f9291921-a076-4690-bfd8-3d76dc65210a: url('<?php echo base_url(); ?>assets/themes/creativewalls/images/our_suppliers_bg.webp');
            }

            .rll-youtube-player .play {
                --wpr-bg-0b072631-da55-4830-a0e2-91fb241f8591: url('<?php echo base_url(); ?>assets/plugins/wp-rocket/assets/img/youtube.png');
            }
        </style>
    </noscript>
</head>