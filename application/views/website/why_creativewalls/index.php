...
<div class="container-fluid">
    ...
    <div class="row sign-up-process-section" style="background-color: #F2F2F2;">
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-lg-12">
                    <div class="why-dc-page-head">
                        <h2 class="covid-sign-up-head">
                            It’s Your Sanctuary. It’s Personal </h2>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-lg-12">
                    <div class="why-dc-page-head">
                        <h2 class="covid-sign-up-head">
                            More Space, More Delight, More Joy in Your Life </h2>
                    </div>
                </div>
                <div class="col-lg-7 order-lg-1 order-2">
                    <div class="why-dc-founder-desc">
                        <p>We have spent countless hours on design, to make your life simpler.</p>
                        <p>Why go down on your knees to reach the back of the bottom shelf, when it can be a pull-out
                            drawer?</p>
                        <p>Left with an odd unusable space on the wall? Our slim end-units add storage or showcase
                            display pieces</p>
                        <p>This, and much more, enabled through our own Virtual Reality (VR) software so you can
                            visualise your home come alive.</p>
                    </div>
                </div>
                <div class="col-lg-5 order-lg-2 order-1">
                    <div class="why-dc-founder-image why-dc-founder-image-cls">
        ...
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-lg-12">
                    <div class="why-dc-page-head">
                        <h2 class="covid-sign-up-head">
                            Your Home is Too Important to Trust in Someone Else’s Hands </h2>
                    </div>
                    <div class="why-dc-founder-desc">
                        <p>Our own designers. Our own factory. Our own workforce. Yes, we are control freaks about
                            quality.</p>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="video-testimonial-slider-why">
                        <div id="owl-why-dc-designer"
        ...
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-lg-12">
                    <div class="why-dc-page-head">
                        <h2 class="covid-sign-up-head">
                            Of Course You Can Afford Great Design </h2>
                    </div>
                    <div class="why-dc-founder-desc">
                        <p>Our designs have won many awards.</p>
                        <p>But our biggest reward is seeing satisfied customers move into their new homes across a range
                            of budgets &#8211; from affordable to high-end.</p>
                    </div>
                </div>
                    ...
                    <div class="section-lp-1-2-table">
                        ...
                        <div class="tr">
                            <div class="td first-cell">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Personalised modern designs</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Old fashioned designs</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td last-cell" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col3-cell-body">
                                    <div class="section-lp-1-2-table-col3-cell-text">
                                        <p>Designs repeated across projects</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tr">
                            <div class="td first-cell">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Experience Centre with hundreds of choices on display, including 13 kitchens
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="td" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Limited choices; no single place to view designs</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td last-cell" style="background-color:#F0F0F0;">
                        ...
                        <div class="tr">
                            <div class="td first-cell">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Experience your interior designs in VR/3D</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td" style="background-color:#F0F0F0;">
                        ...
                        <div class="tr">
                            <div class="td first-cell">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Premium quality materials and manufacturing in our own factory</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Low-quality materials used</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td last-cell" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col3-cell-body">
                                    <div class="section-lp-1-2-table-col3-cell-text">
                                        <p>Materials from local suppliers - quality varies</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tr">
                            <div class="td first-cell">
                                <div class="section-lp-1-2-table-col1-cell-body">
                                    <div class="section-lp-1-2-table-col1-cell-text">
                                        <p>Dedicated happiness manager for your queries</p>
                                    </div>
                                </div>
                            </div>
                            <div class="td" style="background-color:#F0F0F0;">
                            ...
                            <div class="td last-cell" style="background-color:#F0F0F0;">
                                <div class="section-lp-1-2-table-col3-cell-body">
                                    <div class="section-lp-1-2-table-col3-cell-text">
                                        <p>Average service experience</p>
                                    </div>
                                </div>
                            </div>
                        </div>
